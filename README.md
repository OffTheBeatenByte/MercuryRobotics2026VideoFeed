...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
## Distance between April tags  

Using the size of the april tags and the distortion of the camera this estimates the distance between the camera and april tags 

-Start distance.py while in the virtual enviorment (python3 distance.py)
-Be sure to install pupil_apriltags module (pip install pupil_apriltags)
-Hold up a 2x2 april tag to the cam and it should print the results

AUTHORS: Charles Kolb (github @FreeCharles02)
